...
<nav id="site-navigation" class="nav<?php echo esc_attr( $site_navigation_class ); ?> navbar navbar-expand-lg navbar-light" data-mobile-menu-second-click-link="<?php echo esc_attr( $mobile_second_click_link ); ?>">
