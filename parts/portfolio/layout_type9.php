...
<div class="project-page project layout-type9 <?php echo esc_attr($page_container_class); ?>">
    ...
    <div class="page-container <?php echo esc_attr($dark_mode_class); ?>"> 
        <?php $is_content_exist = wp_kses_post( $project['description'] ) != ''  || $project['custom_content_position'] == 'after_description' || $project['task'] || $project['strategy'] || $project['design'] || $project['client'] || $project['custom_fields'] || $project['tags'] || $project['link']?>
