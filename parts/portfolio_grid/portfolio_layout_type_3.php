...
<div class="portfolio-item portfolio-item-fullscreen portfolio-grid-type-3 parallax-holder<?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>"<?php if ($_project_uniqid) {
    ...
    <div class="portfolio-item-overlay">
        <div class="page-container">
            <div class="portfolio-details animated-holder vc_col-lg-6 vc_col-md-8">
