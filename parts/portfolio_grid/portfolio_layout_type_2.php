...
<div class="portfolio-item portfolio-item-grid portfolio-grid-type-2 <?php echo esc_attr( $parallax_class ); ?> <?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>"<?php if ($project['in_popup']) {
    ...
    <a href="<?php echo esc_url($project['url']); ?>"<?php if ($project['external']) { echo ' target="_blank"'; } ?> data-cursor-class="cursor-link" class="portfolio-item-details text-<?php echo esc_attr($alignment) ?>">
