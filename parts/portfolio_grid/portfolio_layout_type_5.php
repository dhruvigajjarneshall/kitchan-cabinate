...
<div class="portfolio-item portfolio-item-fullscreen portfolio-grid-type-5 parallax-holder <?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>"<?php if ($_project_uniqid) {
    echo ' id="' . esc_attr($_project_uniqid) . '"';
} ?><?php if ($project['in_popup']) {
    echo ' data-portfolio-popup="' . esc_attr($project['popup_id']) . '"';
} ?>>
    <div class="parallax">
        <div class="portfolio-item-image" <?php echo ' data-ohio-bg-image="' . esc_url($project['featured_image']) . '"'; ?>></div>
    </div>
    <div class="portfolio-item-overlay ">
        <div class="page-container">
            <div class="portfolio-details animated-holder vc_col-lg-6 vc_col-lg-push-6 vc_col-md-12">
                <?php if (isset($project['video']['link']) && !empty($project['video']['link'])) { ?>
                    <div class="portfolio-details-video with-animation ohio-video-module-sc video-module open-popup"
                        ...
                        <div class="btn-play btn-round <?php if ($project['video_button_style'] == 'outline') { echo ' btn-round-outline btn-round-outline-light'; } ?> " tabindex='1'>
