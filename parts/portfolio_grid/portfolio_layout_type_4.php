...
<div class="portfolio-item portfolio-item-fullscreen portfolio-grid-type-4 parallax-holder<?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>"<?php if ($_project_uniqid) {
