...
register_sidebar( array(
    ...
    'name' => esc_html__( 'Footer column 5', 'ohio' ),

    'id' => 'ohio-sidebar-footer-5',
...
function get_testimonial( $posts_per_page = 1, $orderby = 'none', $testimonial_id = null ) {
    ...
    if ( $query->have_posts() ) {
        while ( $query->have_posts() ) : $query->the_post();
            ...
            $testimonials .= '<div class="testimonial-items">';
            if( isset($img) && ! empty($img) ) 
                $testimonials .= '<div class="testimonial-avatar">' . $img .'</div>';
            $testimonials .= '<div class="testimonial-content">';
            $testimonials .= '<div class="testimonila-name">' . $cite . '</div>';
            $testimonials .= '<p class="mb-0">' . get_the_content() . '</p>';
