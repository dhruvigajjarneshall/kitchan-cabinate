...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/custom/css/bootstrap.min.css'?>" type="text/css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/custom/css/all.min.css'?>" type="text/css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/custom/css/owl.carousel.min.css'?>" type="text/css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/custom/css/swiper.min.css'?>" type="text/css">
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/assets/custom/css/style.css'?>" type="text/css">
	<?php
