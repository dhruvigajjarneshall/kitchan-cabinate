...
<!-- WISHLIST MOBILE -->
<ul class="woo-c_wishlist shop_table cart wishlist_table wishlist_view responsive mobile <?php echo $show_cb ? 'with-checkbox' : '' ?>" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo $wishlist_id ?>" data-token="<?php echo $wishlist_token ?>">
    <?php
    if( $wishlist && $wishlist->has_items() ) :
                    ...
                    <div class="item-wrapper">
                        ...
                        <div class="item-details">
                            <div class="product-name">
                                <h6><?php echo apply_filters( 'woocommerce_in_cartproduct_obj_title', $product->get_title(), $product ) ?></h6>
                    ...
                    <div class="additional-info-wrapper">
                            ...
                            <table class="additional-info">
	                            ...
	                            <?php if( $show_stock_status ) : ?>
                                    <tr>
                                        ...
                                        <td class="value">
                                            <?php echo $stock_status == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . __( 'Out of stock', 'ohio' ) . '</span>' : '<span class="wishlist-in-stock">' . __( 'In Stock', 'ohio' ) . '</span>'; ?>
                                        </td>
                                    </tr>
	                            <?php endif ?>
                            </table>
	                    ...
	                    <?php if( $show_remove_product ): ?>
                            <div class="product-remove">
                                <div class="btn-round btn-round-light btn-round-small">
                                    <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ) ?>" class="remove remove_from_wishlist" title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'ohio' ) ); ?>"><i class="ion ion-md-close"></i></a>    
                                </div>
                            </div>
	                    <?php endif; ?>
                    </div>
        ...
        <p class="wishlist-empty">
            <?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'ohio' ) ) ?>
        </p>
    <?php
    endif;
