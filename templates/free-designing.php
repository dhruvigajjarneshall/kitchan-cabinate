...
get_template_part( 'template-parts/content-header' ); //sub Header
    ...
    if ( have_posts() ) :
        while ( have_posts() ) : the_post();
            ?>
              <section class="pb-5 pt-5" style="margin-top: 40px;">
                <div class="container">
                  <div class="row">
                    <?php 
                        if( have_rows('section_1_image') ):
                            ...
                            while( have_rows('section_1_image') ) : the_row();
                                ...
                                $image = get_sub_field('section_1_sub_image');
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            ...
                            <h5 class="text-gray fw-normal">
                                ...
                                if( isset( $section_3_description ) && ! empty($section_3_description) ) {
                                    echo $section_3_description;
                                }
                            ?></h5>
                        </div>
                    </div>
                                ...
                                if( have_rows('section_4_work_repeater') ):
                                    ...
                                    while( have_rows('section_4_work_repeater') ) : the_row();
                                        ...
                                        if( isset($title) && ! empty($title) && isset($description) && ! empty($description) && isset($icon) && ! empty($icon) ){   
                                            ?>
                                        <div class="col-xl-2 col-md-4 mb-4 mb-md-0">
            ...
            <section class="pb-5">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="section-title mb-5">
                                <h2 class="title">
                                <?php 
                                        $section_5_how_it_measurement_kitchen_cabinets_title = get_field( "section_5_how_it_measurement_kitchen_cabinets_title" ); 
                                        if( isset( $section_5_how_it_measurement_kitchen_cabinets_title ) && ! empty($section_5_how_it_measurement_kitchen_cabinets_title) ) {
                                            echo $section_5_how_it_measurement_kitchen_cabinets_title;
                                        }
                                    ?> </h2>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                       <?php 
                                    $section_5_how_measure_video = get_field( "section_5_how_measure_video" ); 
                                    if( isset( $section_5_how_measure_video ) && ! empty($section_5_how_measure_video) ) {
                                        echo $section_5_how_measure_video;
                                    }
                                ?> 
                    </div>
                </div>
