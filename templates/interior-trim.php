                        ...
                        <?php 
                            if( have_rows('section_1_image') ):
                                ...
                                while( have_rows('section_1_image') ) : the_row();
                                    ...
                                    $image = get_sub_field('section__1__sub_image');
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h5 class="text-gray fw-normal line-height">
                                <?php 
            ...
            <section class="pb-5">
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <?php 
                                if( have_rows('section_2_repeator') ):
                                    $i = 1;
                                    // Loop through rows.
                                    while( have_rows('section_2_repeator') ) : the_row();
                                        // Load sub field value.
                                        $title = get_sub_field('heading_1');
                    ...
                    <div class="col-sm-12">
                        <div class="contact-form">
                            <div class="row align-items-end">
							 <?php echo do_shortcode('[contact-form-7 id="217838" title="Interior Trim" html_class="row"]')?>
                                </div>
                            </form>
                        </div>
                    </div>
